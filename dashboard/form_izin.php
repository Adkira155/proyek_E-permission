...
<body>
<div class="card" style="width: 66%; left: 16.5%; margin-top: 1%; border-radius: 0; background: #fafafa;">
...
<form>
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
      <input type="name" class="form-control" id="inputEmail3" placeholder="Nama Lengkap">
    </div>
  </div>
  ...
  <div class="row mb-3">
    <label for="inputEmail3" class="col-sm-2 col-form-label">Keterangan Tidak Hadir</label>
    <div class="col-sm-10">
            <select class="form-select bg text-white" aria-label="Default select example">

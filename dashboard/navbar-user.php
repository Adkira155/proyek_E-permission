                            ...
                            <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item text-dark" href="#data">Data Pengguna</a>
                                        <a class="dropdown-item text-dark" href="#buat">Membuat Perizinan</a>
                                        <a class="dropdown-item text-dark" href="#tunggu">Menunggu Perizinan</a>
                                        <a class="dropdown-item text-dark" href="#terima">Perizinan Diterima</a>
                                        <a class="dropdown-item text-dark" href="#tolak">Perizinan Ditolak</a>
